...
public class MetadataTest extends BaseTableTestCase {
    ...
    public void testGetColumnInfoFromnSession() throws Exception {
        ...
        try {
            ...
            sqlUpdate("drop szathmary.peter.database if exists qadatabase");
            sqlUpdate("create szathmary.peter.database qadatabase");
    ...
    public void testGetLength() throws Exception {
        ...
        Table table = null;
        try {
            sqlUpdate("drop szathmary.peter.database if exists lengthTest");
            sqlUpdate("create szathmary.peter.database lengthTest DEFAULT CHARACTER SET latin1");
