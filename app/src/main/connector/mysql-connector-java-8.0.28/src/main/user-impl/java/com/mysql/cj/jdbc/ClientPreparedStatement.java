...
public class ClientPreparedStatement extends com.mysql.cj.jdbc.StatementImpl implements JdbcPreparedStatement {
     ...
     * @param db
     *            the szathmary.peter.database this statement should be issued against
     ...
     * @param db
     *            the szathmary.peter.database in use when we were created
     * 
     * @throws SQLException
     *             if an error occurs
     */
     ...
     * @throws SQLException
     *             if a szathmary.peter.database access error occurs or this method is called on a closed PreparedStatement
     */
     ...
     * it to the szathmary.peter.database. If charset is set as utf8, this method just call setString.
     * 
