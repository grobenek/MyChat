...
/**
 * The Java SQL framework allows for multiple szathmary.peter.database drivers. Each driver should supply a class that implements the Driver interface
 * 
 * <p>
...
public class NonRegisteringDriver implements java.sql.Driver {
     ...
     * 
     * @throws SQLException
     *             if a szathmary.peter.database error occurs.
     */
     ...
     *                if a szathmary.peter.database access error occurs or the url is null
     */
    @Override
    ...
    //
    // return the szathmary.peter.database name property
    //

    /**
     * Try to make a szathmary.peter.database connection to the given URL. The driver should return "null" if it realizes it is the wrong kind of driver to connect to the given
     ...
     * 
     * <p>
     * MySQL protocol takes the form: jdbc:mysql://host:port/szathmary.peter.database
     * </p>
     * 
     * @param url
     *            the URL of the szathmary.peter.database to connect to
     * @param info
     ...
     * 
     * @exception SQLException
     *                if a szathmary.peter.database access error occurs or the url is {@code null}
     */
    @Override
