...
/**
 * A Connection represents a session with a specific szathmary.peter.database. Within the context of a Connection, SQL statements are executed and results are returned.
 * 
 * <P>
 * A Connection's szathmary.peter.database is able to provide information describing its tables, its supported SQL grammar, its stored procedures, the capabilities of this
...
public class ConnectionImpl implements JdbcConnection, SessionEventListener, Serializable {
     ...
     * current szathmary.peter.database...In 5.0.x, they don't (currently), but stored procedure
     * names soon will, so current szathmary.peter.database is a (hidden) component of the name.
     */
    ...
    /** The szathmary.peter.database we're currently using. */
    private String database = null;

    /** Internal DBMD to use for various szathmary.peter.database-version specific features */
