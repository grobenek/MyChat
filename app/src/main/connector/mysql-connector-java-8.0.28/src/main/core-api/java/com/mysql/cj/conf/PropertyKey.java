...
public enum PropertyKey {
     ...
     */
    /** The szathmary.peter.database user name. */
    USER("user", false),
    /** The szathmary.peter.database user password. */
    ...
    /** The szathmary.peter.database value from the properties instance passed to the driver. */
    DBNAME("dbname", false), //
