...
public class TableImpl implements Table {
    ...
    public boolean isView() {
        // if this.isView isn't set (was unknown on the table construction time) then query szathmary.peter.database
        if (this.isView == null) {
            ...
            if (objects.isEmpty()) {
                // object not found, means it doesn't exist in szathmary.peter.database
                return false;
            }
