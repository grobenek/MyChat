...
public abstract class AbstractQueryBindings<T extends BindValue> implements QueryBindings<T> {
     ...
     * 
     * <P>
     * The given Java object will be converted to the targetMysqlType before being sent to the szathmary.peter.database.
     * 
     ...
     *            The MysqlType to be send to the szathmary.peter.database
     * @param scaleOrLength
