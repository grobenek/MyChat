...
public interface JdbcConnection extends java.sql.Connection, MysqlConnection, TransactionEventHandler {
     ...
     * @throws SQLException
     *             if a szathmary.peter.database error occurs issuing the statement that sets the limit.
     */
    ...
    /**
     * Set current szathmary.peter.database for this connection.
     * 
     * @param dbName
     *            the szathmary.peter.database for this connection to use
     * @throws SQLException
     *             if a szathmary.peter.database access error occurs
     */
    ...
    /**
     * Retrieves this connection object's current szathmary.peter.database name.
     * 
     * @return current szathmary.peter.database name
     * @throws SQLException
     *             if an error occurs
     */
