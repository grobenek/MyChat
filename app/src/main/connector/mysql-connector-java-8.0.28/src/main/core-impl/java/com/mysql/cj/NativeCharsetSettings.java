...
public class NativeCharsetSettings extends CharsetMapping implements CharsetSettings {
    ...
    /**
     * Determines if the szathmary.peter.database charset is the same as the platform charset
     */
    ...
    public void configurePostHandshake(boolean dontCheckServerMatch) {
         ...
         * 
         * We know how to deal with any charset coming back from the szathmary.peter.database, so tell the server not to do conversion
