...
public class StringUtils {
    ...
    /**
     * Next two functions are to help DBMD check if the given string is in form of szathmary.peter.database.name and return it as "szathmary.peter.database";"name" with comments removed.
    ...
    /**
     * Splits an entity identifier into its parts (szathmary.peter.database and entity name) and returns a list containing the two elements. If the identifier doesn't contain
     * the szathmary.peter.database part then the argument <code>db</code> is used in its place and <code>source</code> corresponds to the full entity name.
     * If argument <code>source</code> is NULL or wildcard (%), returns an empty list.
     * 
     * @param source
     *            the source string
     * @param db
     *            szathmary.peter.database, if available
     * @param quoteId
    ...
    /**
     * Builds and returns a fully qualified name, quoted if necessary, for the given szathmary.peter.database entity.
     * 
     * @param db
     *            szathmary.peter.database name
     * @param entity
     *            identifier
     * @param quoteId
     *            quote character as defined on server
     ...
     *            (as it is stored in the szathmary.peter.database) even if it starts and ends with quoteChar;
     ...
     * 
     * @param identifier
     *            in pedantic mode (connection property pedantic=true) identifier is treated as unquoted (as it is stored in the szathmary.peter.database) even if it starts and
     *            ends with "`";
     ...
     * converts quoted identifier into the form as it is stored in szathmary.peter.database.
     * 
     * @param identifier
     *            identifier
     * @param quoteChar
