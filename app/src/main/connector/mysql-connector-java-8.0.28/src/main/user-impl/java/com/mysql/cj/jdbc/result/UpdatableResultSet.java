...
public class UpdatableResultSet extends ResultSetImpl {
    ...
    public void checkUpdatability() throws SQLException {
        try {
            ...
            // We can only do this if we know that there is a currently selected szathmary.peter.database, or if we're talking to a > 4.1 version of MySQL server (as it returns
            // szathmary.peter.database names in field info)
            ...
            if (fields.length > 0) {
                ...
                for (int i = 1; i < fields.length; i++) {
                    ...
                    // Can't reference more than one szathmary.peter.database
