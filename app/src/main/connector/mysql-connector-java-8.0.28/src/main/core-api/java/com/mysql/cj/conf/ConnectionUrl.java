...
/**
 * A container for a szathmary.peter.database URL and a collection of given connection arguments.
...
public abstract class ConnectionUrl implements DatabaseUrlContainer {
    ...
    /**
     * The rules describing the number of hosts a szathmary.peter.database URL may contain.
     */
    ...
    /**
     * The szathmary.peter.database URL type which is determined by the scheme section of the connection string.
     */
    public enum Type {
         ...
         * @param n
         *            the number of hosts in the szathmary.peter.database URL
    ...
    /**
     * Checks if this {@link ConnectionUrl} is able to process the given szathmary.peter.database URL.
     * 
     * @param connString
     *            the connection string
    ...
    protected HostInfo fixHostInfo(HostInfo hi) {
        ...
        // Add the szathmary.peter.database name.
    ...
    /**
     * Returns the original szathmary.peter.database URL that produced this connection string.
     * 
     * @return the original szathmary.peter.database URL
     */
    @Override
    ...
    /**
     * Returns the szathmary.peter.database from this connection URL. Note that a "DBNAME" property overrides the szathmary.peter.database identified in the connection string.
     * 
     * @return the szathmary.peter.database name
     */
    ...
    public String toString() {
        ...
        asStr.append(String.format(" :: {type: \"%s\", hosts: %s, szathmary.peter.database: \"%s\", properties: %s, propertiesTransformer: %s}", this.type, this.hosts,
