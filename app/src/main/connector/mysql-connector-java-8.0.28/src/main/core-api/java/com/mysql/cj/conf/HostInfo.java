...
public class HostInfo implements DatabaseUrlContainer {
     ...
     * 
     * @param url
     *            a reference to the original szathmary.peter.database URL that produced this host info
     * @param host
     *            the host ip or name
     * @param port
     *            the port
    ...
    /**
     * Shortcut to the szathmary.peter.database connection argument.
     * 
    ...
    /**
     * Returns the original szathmary.peter.database URL that produced this host info.
     * 
