...
public class MysqlDataSource extends JdbcPropertySetImpl implements DataSource, Referenceable, Serializable, JdbcPropertySet {
    ...
    /**
     * Sets the szathmary.peter.database name.
     * 
     * @param dbName
     *            the name of the szathmary.peter.database
     */
    ...
    /**
     * Gets the name of the szathmary.peter.database
     * 
     * @return the name of the szathmary.peter.database for this data source
     */
    ...
    /**
     * Sets the szathmary.peter.database port.
     * 
     * @param p
     *            the port
     */
    ...
    /**
     * Returns the name of the szathmary.peter.database server
     * 
     * @return the name of the szathmary.peter.database server
     */
    ...
    /**
     * Returns the JDBC URL that will be used to create the szathmary.peter.database connection.
     * 
     * @return the URL for this connection
     */
    public String getUrl() {
     ...
     * 
     * @return a connection to the szathmary.peter.database
     * 
     * @throws SQLException
     *             if an error occurs
     */
