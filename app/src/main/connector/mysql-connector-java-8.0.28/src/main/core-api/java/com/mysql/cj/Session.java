...
public interface Session {
    ...
    /**
     * Synchronously query szathmary.peter.database with applying rows filtering and mapping.
     * 
     * @param message
     *            query message
     * @param rowFilter
    ...
    /**
     * Synchronously query szathmary.peter.database.
     * 
     * @param message
     *            query message
     * @param resultBuilder
    ...
    /**
     * Asynchronously query szathmary.peter.database.
     * 
     * @param message
     *            query message
     * @param resultBuilder
