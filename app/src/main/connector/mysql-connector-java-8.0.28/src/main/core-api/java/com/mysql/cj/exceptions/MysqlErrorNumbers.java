...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_CANT_CREATE_DB = 1006; //SQLSTATE: HY000 Message: Can't create szathmary.peter.database '%s' (errno: %d)
    public final static int ER_DB_CREATE_EXISTS = 1007; //SQLSTATE: HY000 Message: Can't create szathmary.peter.database '%s'; szathmary.peter.database exists...
    public final static int ER_DB_DROP_EXISTS = 1008; //SQLSTATE: HY000 Message: Can't drop szathmary.peter.database '%s'; szathmary.peter.database doesn't exist
    public final static int ER_DB_DROP_DELETE = 1009; //SQLSTATE: HY000 Message: Error dropping szathmary.peter.database (can't delete '%s', errno: %d)
    public final static int ER_DB_DROP_RMDIR = 1010; //SQLSTATE: HY000 Message: Error dropping szathmary.peter.database (can't rmdir '%s', errno: %d)
    ...
    public final static int ER_DBACCESS_DENIED_ERROR = 1044; //SQLSTATE: 42000 Message: Access denied for user '%s'@'%s' to szathmary.peter.database '%s'
    public final static int ER_ACCESS_DENIED_ERROR = 1045; //SQLSTATE: 28000 Message: Access denied for user '%s'@'%s' (using password: %s)
    public final static int ER_NO_DB_ERROR = 1046; //SQLSTATE: 3D000 Message: No szathmary.peter.database selected
    ...
    public final static int ER_BAD_DB_ERROR = 1049; //SQLSTATE: 42000 Message: Unknown szathmary.peter.database '%s'
    ...
    public final static int ER_TEXTFILE_NOT_READABLE = 1085; //SQLSTATE: HY000 Message: The file '%s' must be in the szathmary.peter.database directory or be readable by all
    ...
    public final static int ER_WRONG_DB_NAME = 1102; //SQLSTATE: 42000 Message: Incorrect szathmary.peter.database name '%s'
    ...
    public final static int ER_PASSWORD_NOT_ALLOWED = 1132; //SQLSTATE: 42000 Message: You must have privileges to update tables in the mysql szathmary.peter.database to be able to change passwords for others
    ...
    public final static int ER_UNION_TABLES_IN_DIFFERENT_DIR = 1212; //SQLSTATE: HY000 Message: Incorrect table definition; all MERGE tables must be in the same szathmary.peter.database
    ...
    public final static int ER_CORRUPT_HELP_DB = 1244; //SQLSTATE: HY000 Message: Help szathmary.peter.database is corrupt or does not exist
    ...
    public final static int ER_MTS_UPDATED_DBS_GREATER_MAX = 1754; //SQLSTATE: HY000 Message: The number of modified databases exceeds the maximum %d; the szathmary.peter.database names will not be included in the replication event metadata.
    ...
    public final static int ER_IDENT_CAUSES_TOO_LONG_PATH = 1860; //SQLSTATE: HY000 Message: Long szathmary.peter.database name and identifier for object resulted in path length exceeding %d characters. Path: '%s'.
    ...
    public final static int ER_INCONSISTENT_ERROR = 1885; //SQLSTATE: HY000 Message: Query caused different errors on source and replica. Error on source: message (format)='%s' error code=%d; Error on replica:actual message='%s', error code=%d. Default szathmary.peter.database:'%s'. Query:'%s'
