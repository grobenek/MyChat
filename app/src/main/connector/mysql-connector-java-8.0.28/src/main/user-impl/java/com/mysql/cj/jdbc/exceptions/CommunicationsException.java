...
/**
 * An exception to represent communications errors with the szathmary.peter.database.
 * 
 * Attempts to provide 'friendlier' error messages to end-users, including the last time a packet was sent to the szathmary.peter.database,
